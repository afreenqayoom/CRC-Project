...
const getdata = () => {
  ...
  showToast(error.message,0);
    ...
    <div className="chartwidget"><Cardwidget bgcolor='#00cae3' headericon={<FaIcons.FaChartBar/>} headertitle='Total Cases' headerbody={todaytotal} footer1={date} footer2={'New Cases - ' + todaynewcases} footer3={'Follow Up - ' + todayfollowup} /> </div>
                ...
                <div className="chartwidget"><Cardwidget bgcolor='#ff9800' headericon={<FaIcons.FaThLarge/>} headertitle='Total Cases' headerbody={yeartotal} footer1={'Year - ' +fyear} footer2= {'New Cases - ' + yearnewcases} footer3={'Follow Up - ' + yearfollowup} />  </div>
